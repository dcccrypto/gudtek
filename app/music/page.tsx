...
export default function GudMusicPage() {
  ...
  const shareToTikTok = (track: Track) => {
    // Open TikTok profile since TikTok doesn't have a direct share URL like Twitter
    window.open('https://www.tiktok.com/@gudteksolana', '_blank', 'noopener,noreferrer')
  }
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 mb-8 flex-wrap">
                          ...
                          <Button 
                            variant="outline" 
                            size="sm"
                            onClick={() => shareToTikTok(currentTrack)}
                            className="bg-white/20 border-white/30 hover:bg-white/30"
                          >
